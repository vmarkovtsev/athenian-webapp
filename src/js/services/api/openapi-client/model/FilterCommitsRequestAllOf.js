...
class FilterCommitsRequestAllOf {
     ...
     * @param property {module:model/FilterCommitsRequestAllOf.PropertyEnum} Main trait of the commits - the core of the filter. * no_pr_merges: select all the commits but PR merges by noreply@github.com * bypassing_prs: select commits that were pushed without creating a PR
     */
