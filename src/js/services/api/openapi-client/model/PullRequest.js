...
class PullRequest {
     ...
     */
    constructor(repository, _number, title, sizeAdded, sizeRemoved, filesChanged, created, updated, comments, commits, reviewRequested, reviewComments, stage, participants) { 
        
        PullRequest.initialize(this, repository, _number, title, sizeAdded, sizeRemoved, filesChanged, created, updated, comments, commits, reviewRequested, reviewComments, stage, participants);
    }
     ...
     */
    static initialize(obj, repository, _number, title, sizeAdded, sizeRemoved, filesChanged, created, updated, comments, commits, reviewRequested, reviewComments, stage, participants) { 
