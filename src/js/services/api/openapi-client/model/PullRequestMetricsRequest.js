...
class PullRequestMetricsRequest {
     ...
     * @param _for {Array.<module:model/ForSet>} Sets of developers and repositories for which to calculate the metrics. The aggregation is `AND` between repositories and developers. The aggregation is `OR` inside both repositories and developers. Any contribution role is matched: authors, reviewers, commenters, committers, releasers.
...
/**
 * Sets of developers and repositories for which to calculate the metrics. The aggregation is `AND` between repositories and developers. The aggregation is `OR` inside both repositories and developers. Any contribution role is matched: authors, reviewers, commenters, committers, releasers.
 ...
 */
PullRequestMetricsRequest.prototype['exclude_inactive'] = undefined;
