...
class CalculatedMetrics {
     ...
     * @param calculated {Array.<module:model/CalculatedMetric>} The values of the requested metrics through time. The sequence order is not guaranteed to be the same as in the preceding request.
...
/**
 * The values of the requested metrics through time. The sequence order is not guaranteed to be the same as in the preceding request.
