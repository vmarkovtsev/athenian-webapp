...
import PullRequestSetInclude from './PullRequestSetInclude';
...
class PullRequestSet {
     ...
     * @param include {module:model/PullRequestSetInclude} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('include')) {
                obj['include'] = PullRequestSetInclude.constructFromObject(data['include']);
            }
...
/**
 * @member {module:model/PullRequestSetInclude} include
 */
