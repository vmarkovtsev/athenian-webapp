...
import ForSetDevelopers from './ForSetDevelopers';
...
class DeveloperMetricsRequest {
     ...
     * @param _for {Array.<module:model/ForSetDevelopers>} Sets of developers and repositories to calculate the metrics for.
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('for')) {
                obj['for'] = ApiClient.convertToType(data['for'], [ForSetDevelopers]);
            }
 ...
 * @member {Array.<module:model/ForSetDevelopers>} for
 */
