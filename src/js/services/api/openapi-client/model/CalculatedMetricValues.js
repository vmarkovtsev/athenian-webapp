...
import OneOfintegerfloatstring from './OneOfintegerfloatstring';
...
class CalculatedMetricValues {
     ...
     * @param values {Array.<module:model/OneOfintegerfloatstring>} Calculated metric values in the same order as `metrics`.
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [OneOfintegerfloatstring]);
            }
            if (data.hasOwnProperty('confidence_mins')) {
                obj['confidence_mins'] = ApiClient.convertToType(data['confidence_mins'], [OneOfintegerfloatstring]);
            }
            if (data.hasOwnProperty('confidence_maxs')) {
                obj['confidence_maxs'] = ApiClient.convertToType(data['confidence_maxs'], [OneOfintegerfloatstring]);
            }
 ...
 * @member {Array.<module:model/OneOfintegerfloatstring>} values
 */
 ...
 * @member {Array.<module:model/OneOfintegerfloatstring>} confidence_mins
 */
 ...
 * @member {Array.<module:model/OneOfintegerfloatstring>} confidence_maxs
 */
